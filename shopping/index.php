...
<html lang="en">
	<head>
	    ...
	    <title>One Stop Kiosk System</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
	    ...
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(img/logo.jpeg);">
			</div><!-- /.item -->
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">FREE SHIPPING ORDER OVER RM 100</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">SPECIAL SALES ON SPECIAL OCCASSIONS </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
