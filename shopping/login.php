...
<html lang="en">
	<head>
	    ...
	    <title>One Stop Kiosk | SignIn | SignUp</title>
...
<div class="form-group">
	    	...
	    	<input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" maxlength="50" required >
	  	</div>
